...
void lcd_ex_ili9486_reginit(void)
{
	...
	lcd_wr_regno(0XF8);	lcd_wr_data(0x21);	lcd_wr_data(0x04);
	lcd_wr_regno(0XF9);	lcd_wr_data(0x00);	lcd_wr_data(0x08);
	lcd_wr_regno(0X36);	lcd_wr_data(0X08);	
	lcd_wr_regno(0X3A);	lcd_wr_data(0x05);
	lcd_wr_regno(0XB4);	lcd_wr_data(0x01);	
	lcd_wr_regno(0XB6);	lcd_wr_data(0X02);	lcd_wr_data(0x22);
	lcd_wr_regno(0XC1);	lcd_wr_data(0X41);
	lcd_wr_regno(0XC5);	lcd_wr_data(0X00);	lcd_wr_data(0x07);
